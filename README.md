...
- **声音克隆音色**：上传一段人声样本（3–30s，wav/mp3）即可克隆成专属音色，做角色音或个人声线。全局共享，像预置音色一样选用。走 MiMo voiceclone 模型（当前限时免费，后续可能收费），UI 有「付费」标注提示
...
- 预置音色是 MiMo 的 4 个中文音色；想要角色音/网红音，用声音克隆上传样本（voiceclone 模型当前限时免费）
